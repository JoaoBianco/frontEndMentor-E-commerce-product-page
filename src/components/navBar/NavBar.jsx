  ...
  return (
    <div className="container">
      <nav className="navBar | flex gap-400">
        ...
        <div className={`navBar__items ${isMenuClosed ? "hidden" : ""}`}>
          <motion.ul
            variants={hambuguerMenuItem}
            initial="hidden"
            animate="visible"
            transition={{
              duration: 1,
          ...
          >
            <button
              ...
              className="hamburguer__menu hamburguer__menu--close"
            >
              <motion.svg
                width="16"
                height="15"
        ...
        <div className="navBar__cart | flex gap-700">
          ...
          <motion.a
            ...
            href="/"
          >
            <img className="navbar__cart--img" src={avatar} alt="" />
          </motion.a>
        </div>
      </nav>
    </div>
